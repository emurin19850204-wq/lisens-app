...
export const courseProgresses: CourseProgress[] = [
  ...
  { id: 'prog-1', userId: 'user-learner1', subjectId: 'sub-co1', status: 'completed', startedAt: '2024-04-08T00:00:00Z', completedAt: '2024-04-08T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-2', userId: 'user-learner1', subjectId: 'sub-co2', status: 'completed', startedAt: '2024-04-08T00:00:00Z', completedAt: '2024-04-08T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-3', userId: 'user-learner1', subjectId: 'sub-co3', status: 'completed', startedAt: '2024-04-09T00:00:00Z', completedAt: '2024-04-09T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-4', userId: 'user-learner1', subjectId: 'sub-co4', status: 'completed', startedAt: '2024-04-10T00:00:00Z', completedAt: '2024-04-10T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-5', userId: 'user-learner1', subjectId: 'sub-co5', status: 'in_progress', startedAt: '2024-04-11T00:00:00Z', completedAt: null, createdAt: ts, updatedAt: ts },
  { id: 'prog-6', userId: 'user-learner1', subjectId: 'sub-co6', status: 'not_started', startedAt: null, completedAt: null, createdAt: ts, updatedAt: ts },
  { id: 'prog-7', userId: 'user-learner1', subjectId: 'sub-co7', status: 'not_started', startedAt: null, completedAt: null, createdAt: ts, updatedAt: ts },
  { id: 'prog-8', userId: 'user-learner1', subjectId: 'sub-co8', status: 'not_started', startedAt: null, completedAt: null, createdAt: ts, updatedAt: ts },
  { id: 'prog-9', userId: 'user-learner1', subjectId: 'sub-w1', status: 'completed', startedAt: '2024-04-15T00:00:00Z', completedAt: '2024-04-15T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-10', userId: 'user-learner1', subjectId: 'sub-w2', status: 'in_progress', startedAt: '2024-04-16T00:00:00Z', completedAt: null, createdAt: ts, updatedAt: ts },
  // 田中美咲: 共通コア完了、ウェイト完了、ピラティス進行中、ブラッシュアップ開始
  { id: 'prog-20', userId: 'user-learner2', subjectId: 'sub-co1', status: 'completed', startedAt: '2024-02-05T00:00:00Z', completedAt: '2024-02-05T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-21', userId: 'user-learner2', subjectId: 'sub-co2', status: 'completed', startedAt: '2024-02-05T00:00:00Z', completedAt: '2024-02-05T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-22', userId: 'user-learner2', subjectId: 'sub-co3', status: 'completed', startedAt: '2024-02-06T00:00:00Z', completedAt: '2024-02-06T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-23', userId: 'user-learner2', subjectId: 'sub-co4', status: 'completed', startedAt: '2024-02-07T00:00:00Z', completedAt: '2024-02-07T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-24', userId: 'user-learner2', subjectId: 'sub-co5', status: 'completed', startedAt: '2024-02-08T00:00:00Z', completedAt: '2024-02-08T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-25', userId: 'user-learner2', subjectId: 'sub-co6', status: 'completed', startedAt: '2024-02-08T00:00:00Z', completedAt: '2024-02-08T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-26', userId: 'user-learner2', subjectId: 'sub-co7', status: 'completed', startedAt: '2024-02-09T00:00:00Z', completedAt: '2024-02-09T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-27', userId: 'user-learner2', subjectId: 'sub-co8', status: 'completed', startedAt: '2024-02-09T00:00:00Z', completedAt: '2024-02-09T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-28', userId: 'user-learner2', subjectId: 'sub-p1', status: 'completed', startedAt: '2024-04-01T00:00:00Z', completedAt: '2024-04-01T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-29', userId: 'user-learner2', subjectId: 'sub-p2', status: 'completed', startedAt: '2024-04-02T00:00:00Z', completedAt: '2024-04-02T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-30', userId: 'user-learner2', subjectId: 'sub-p3', status: 'in_progress', startedAt: '2024-04-03T00:00:00Z', completedAt: null, createdAt: ts, updatedAt: ts },
  // 高橋健太: 共通コア 25%完了
  { id: 'prog-40', userId: 'user-learner3', subjectId: 'sub-co1', status: 'completed', startedAt: '2024-07-08T00:00:00Z', completedAt: '2024-07-08T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-41', userId: 'user-learner3', subjectId: 'sub-co2', status: 'completed', startedAt: '2024-07-08T00:00:00Z', completedAt: '2024-07-08T00:00:00Z', createdAt: ts, updatedAt: ts },
  { id: 'prog-42', userId: 'user-learner3', subjectId: 'sub-co3', status: 'in_progress', startedAt: '2024-07-09T00:00:00Z', completedAt: null, createdAt: ts, updatedAt: ts },
];
